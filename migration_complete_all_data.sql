-- IMPORTACIÓN COMPLETA - MIEMBROS Y VEHÍCULOS
SET NOCOUNT ON;
BEGIN TRANSACTION;
...
VALUES
    (1, 1, N'OSCAR ANGELO GARCIA BUITRAGO', N'NO',
     N'COLOMBIA', 2024, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
    (1, 2, N'GUILLERMO OLAYA ACEVEDO', N'NO',
     N'COLOMBIA', 2017, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (1, 8, N'WILLIAM GABRIEL OCAMPO SUAREZ', N'NO',
     N'COLOMBIA', 2020, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (1, 11, N'JUAN JOSÉ GÓMEZ', N'NO',
     N'COLOMBIA', 2023, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (3, 65, N'Luis Fernando  Peralta Franco', N'NO',
     N'COLOMBIA', 2015, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (3, 68, N'Jorge Alberto Valencia Callejas', N'NO',
     N'COLOMBIA', 2016, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (5, 112, N'RAMIREZ QUIROGA WILSON', N'NO',
     N'COLOMBIA', 2019, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (5, 114, N'GUERRERO SANCHEZ MIGUEL ANGEL', N'NO',
     N'COLOMBIA', 2020, N'Chapter Vice-President', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
    (5, 115, N'RANGEL NUMA GUSTAVO ADOLFO', N'NO',
     N'COLOMBIA', 2021, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
    (5, 116, N'MUNERA VARGAS JUAN STIVEN', N'NO',
     N'COLOMBIA', 2022, N'Full Color Member', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
...
VALUES
    (6, 136, N'VICTOR GONZALO MEJIA ARCILA', N'NO',
     N'COLOMBIA', 2021, N'CHAPTER VICE-PRESIDEN', 1);
INSERT INTO [dbo].[Members]
    ([ChapterId], [Order], [ Complete Names], [Dama], [Country Birth], [In Lama Since], [STATUS], [is_eligible])
VALUES
